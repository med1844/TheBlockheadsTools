...
impl ChunkDynamicObjects {
    ...
    pub fn insert(&mut self, any_dyn_obj: AnyDynamicObject) {
        match any_dyn_obj {
            AnyDynamicObject::Dodo(v) => self.dodo.push(*v),
            ...
            AnyDynamicObject::DropBear(v) => self.dropbear.push(*v),
            AnyDynamicObject::Donkey(v) => self.donkey.push(*v),
            AnyDynamicObject::Egg(v) => self.egg.push(*v),
            AnyDynamicObject::ClownFish(v) => self.clown_fish.push(*v),
            AnyDynamicObject::Shark(v) => self.shark.push(*v),
            ...
            AnyDynamicObject::TradingPost(v) => self.trading_post.push(*v),
            AnyDynamicObject::TrainStation(v) => self.train_station.push(*v),
            AnyDynamicObject::TradePortal(v) => self.trade_portal.push(*v),
            AnyDynamicObject::Scorpion(v) => self.scorpion.push(*v),
            AnyDynamicObject::Painting(v) => self.painting.push(*v),
            AnyDynamicObject::Column(v) => self.column.push(*v),
            AnyDynamicObject::Stairs(v) => self.stairs.push(*v),
            AnyDynamicObject::ElevatorMotor(v) => self.elevator_motor.push(*v),
            AnyDynamicObject::ElevatorShaft(v) => self.elevator_shaft.push(*v),
            AnyDynamicObject::OwnershipSign(v) => self.ownership_sign.push(*v),
            AnyDynamicObject::Yak(v) => self.yak.push(*v),
            AnyDynamicObject::Mirror(v) => self.mirror.push(*v),
        }
    }
    ...
    pub fn get(
        ...
        Some(match dyn_obj_ty {
            ...
            Dodo => AnyDynamicObjectRef::Dodo(self.dodo.get(index)?),
            ...
            DropBear => AnyDynamicObjectRef::DropBear(self.dropbear.get(index)?),
            // GatherBlock => self.gather_block.get(index),
            // CarrotPlant => self.carrot_plant.get(index),
            Donkey => AnyDynamicObjectRef::Donkey(self.donkey.get(index)?),
            ...
            ClownFish => AnyDynamicObjectRef::ClownFish(self.clown_fish.get(index)?),
            Shark => AnyDynamicObjectRef::Shark(self.shark.get(index)?),
            ...
            TradingPost => AnyDynamicObjectRef::TradingPost(self.trading_post.get(index)?),
            TrainStation => AnyDynamicObjectRef::TrainStation(self.train_station.get(index)?),
            TradePortal => AnyDynamicObjectRef::TradePortal(self.trade_portal.get(index)?),
            Scorpion => AnyDynamicObjectRef::Scorpion(self.scorpion.get(index)?),
            Painting => AnyDynamicObjectRef::Painting(self.painting.get(index)?),
            Column => AnyDynamicObjectRef::Column(self.column.get(index)?),
            Stairs => AnyDynamicObjectRef::Stairs(self.stairs.get(index)?),
            ElevatorMotor => AnyDynamicObjectRef::ElevatorMotor(self.elevator_motor.get(index)?),
            ElevatorShaft => AnyDynamicObjectRef::ElevatorShaft(self.elevator_shaft.get(index)?),
            // GemTree => self.gem_tree.get(index),
            // VinePlant => self.vine_plant.get(index),
            // TulipPlant => self.tulip_plant.get(index),
            OwnershipSign => AnyDynamicObjectRef::OwnershipSign(self.ownership_sign.get(index)?),
            // WheatPlant => self.wheat_plant.get(index),
            // TomatoPlant => self.tomato_plant.get(index),
            Yak => AnyDynamicObjectRef::Yak(self.yak.get(index)?),
            Mirror => AnyDynamicObjectRef::Mirror(self.mirror.get(index)?),
            _ => None?,
        })
    }
}
