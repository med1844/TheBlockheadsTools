...
pub enum BlockContent {
    ...
    AppleTreeLeaf = 3,
    AppleTreeTrunk = 4,
    AppleTreeTrunkWithLeaf = 5,
    PineTreeLeaf = 6,
    PineTreeTrunk = 7,
    PineTreeTrunkWithLeaf = 8,
    MapleTreeLeaf = 9,
    MapleTreeTrunk = 10,
    MapleTreeTrunkWithLeaf = 11,
    MangoTreeLeaf = 12,
    MangoTreeTrunk = 13,
    MangoTreeTrunkWithLeaf = 14,
    CoconutTreeLeaf = 15,
    CoconutTreeTrunk = 16,
    OrangeTreeLeaf = 18,
    OrangeTreeTrunk = 19,
    OrangeTreeTrunkWithLeaf = 20,
    CherryTreeLeaf = 21,
    CherryTreeTrunk = 22,
    CherryTreeTrunkWithLeaf = 23,
    CoffeeTreeLeaf = 24,
    CoffeeTreeTrunk = 25,
    CoffeeTreeTrunkWithLeaf = 26,
    ...
    AmethystTreeTrunkWithLeaf = 111,
    SapphireTreeTrunk = 112,
    SapphireTreeLeaf = 113,
    SapphireTreeTrunkWithLeaf = 114,
    EmeraldTreeTrunk = 115,
    EmeraldTreeLeaf = 116,
    EmeraldTreeTrunkWithLeaf = 117,
    RubyTreeTrunk = 118,
    RubyTreeLeaf = 119,
    RubyTreeTrunkWithLeaf = 120,
    DiamondTreeTrunk = 121,
    DiamondTreeLeaf = 122,
    DiamondTreeTrunkWithLeaf = 123,
}
...
impl BlockContent {
    pub fn try_from_u8(value: u8) -> Result<Self, BhError> {
        match value {
            ...
            91 => Ok(Self::LimeTreeTrunkWithLeaf),
