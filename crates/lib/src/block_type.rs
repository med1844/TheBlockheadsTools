...
pub enum BlockContent {
    ...
    Flint = 1,
    Clay = 2,
    AppleTreeLeafEarlySummer = 3,
    AppleTreeTrunk = 4,
    AppleTreeTrunkWithLeafEarlySummer = 5,
    PineTreeLeaf = 6,
    PineTreeTrunk = 7,
    PineTreeTrunkWithLeaf = 8,
    MapleTreeLeafEarlySummer = 9,
    MapleTreeTrunk = 10,
    MapleTreeTrunkWithLeafEarlySummer = 11,
    MangoTreeLeaf = 12,
    MangoTreeTrunk = 13,
    ...
    CherryTreeLeafEarlySummer = 21,
    CherryTreeTrunk = 22,
    CherryTreeTrunkWithLeafEarlySummer = 23,
    CoffeeTreeLeaf = 24,
    CoffeeTreeTrunk = 25,
...
impl BlockContent {
    pub fn try_from_u8(value: u8) -> Result<Self, BhError> {
        match value {
            ...
            1 => Ok(Self::Flint),
            2 => Ok(Self::Clay),
            3 => Ok(Self::AppleTreeLeafEarlySummer),
            4 => Ok(Self::AppleTreeTrunk),
            5 => Ok(Self::AppleTreeTrunkWithLeafEarlySummer),
            6 => Ok(Self::PineTreeLeaf),
            7 => Ok(Self::PineTreeTrunk),
            8 => Ok(Self::PineTreeTrunkWithLeaf),
            9 => Ok(Self::MapleTreeLeafEarlySummer),
            10 => Ok(Self::MapleTreeTrunk),
            11 => Ok(Self::MapleTreeTrunkWithLeafEarlySummer),
            ...
            21 => Ok(Self::CherryTreeLeafEarlySummer),
            22 => Ok(Self::CherryTreeTrunk),
            23 => Ok(Self::CherryTreeTrunkWithLeafEarlySummer),
