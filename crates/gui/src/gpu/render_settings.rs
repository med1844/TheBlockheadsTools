...
pub struct RenderSettingsUniform {
    ...
    pub ambient_light: f32,      // 4 bytes (offset 20)
    pub shininess: f32,          // 4 bytes (offset 24)
    pub specular_intensity: f32, // 4 bytes (offset 28)
    pub min_depth_factor: f32,   // 4 bytes (offset 32)
    pub _padding: [u32; 3],      // 12 bytes (pad to 48)
}
