...
class InteractionObject(DynamicObject):
    interaction_object_type: int
    is_in_use: bool
    flipped: bool
    paint_color: int
    def __repr__(self) -> str: ...
...
class Chest(InteractionObject):
    def __repr__(self) -> str: ...


class StandardChest(Chest):
    def __len__(self) -> int: ...
    def __getitem__(self, index: int) -> 'Slot': ...
    def __setitem__(self, index: int, value: 'Slot') -> None: ...
    def __init__(self, slots: Optional[list['Slot']] = None, owner_id: Optional[str] = None) -> None: ...


class SafeChest(Chest):
    def __len__(self) -> int: ...
    def __getitem__(self, index: int) -> 'Slot': ...
    def __setitem__(self, index: int, value: 'Slot') -> None: ...
    def __init__(self, slots: Optional[list['Slot']] = None, owner_id: Optional[str] = None) -> None: ...
...
class ShelfChest(Chest):
    def __len__(self) -> int: ...
    def __getitem__(self, index: int) -> 'Slot': ...
    def __setitem__(self, index: int, value: 'Slot') -> None: ...
    render_items: Optional[list[ItemType]]
    item_data_bs: Optional[list[int]]
    def __init__(
        self,
        slots: Optional[list['Slot']] = None,
        render_items: Optional[list[ItemType]] = None,
        item_data_bs: Optional[list[int]] = None,
...
class PortalChest(Chest):
    def __init__(self, owner_id: Optional[str] = None) -> None: ...


class Workbench(InteractionObject):
...
class Item:
    """A single item inside a slot. Represents the blockhead's item implementation precisely."""
    type_id: int
    data_a: int
    data_b: int
    selected_sub_item_index: int
    padding: int
    sub_items: Slots | None
    dynamic_object: InteractionObject | None

    def __init__(
        self,
        item_type: ItemType,
        sub_items: Slots | None = None,
        dynamic_object: InteractionObject | None = None,
    ): ...

    @property
    def item_type(self) -> ItemType: ...
    @item_type.setter
    def item_type(self, item_type: ItemType): ...
    @property
    def damage(self) -> int: ...
    @damage.setter
