...
class Item:
    ...
    def __init__(
        self,
        item_type: ItemType,
        extra: Optional[BasketExtra | Chest | WorkbenchExtra] = None,
    ) -> None: ...
    @property
    ...
    @property
    def extra(self) -> Optional[BasketExtra | Chest | WorkbenchExtra]: ...
    @extra.setter
    def extra(
        self, value: Optional[BasketExtra | Chest | WorkbenchExtra]
    ) -> None: ...
    def __repr__(self) -> str: ...
